...
int main(int argc,char**argv){
    ...
    string in=argv[2];
    auto l1=parseIntArray(in,"l1");
    auto l2=parseIntArray(in,"l2");
    Solution sol;
    auto r=sol.addTwoNumbers(vecToList(l1), vecToList(l2));
    auto out=listToVec(r);
    cout<<"{\"result\": "<<vecToStr(out)<<", \"execution_time\": 0}\n";
    return 0;
}