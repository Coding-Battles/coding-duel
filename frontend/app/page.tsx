          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-[1fr_2fr] h-[80%]">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="grid items-center max-w-md grid-cols-2 gap-4 mx-auto lg:mx-0">
                <Link href="guestlogin" className="w-auto px-4 py-1 font-medium text-center border-2 rounded-lg outline-border">
                  Play as Guest
                </Link>
      ...
      <section className="w-auto h-auto px-6 pt-10 pb-20 lg:px-2 wavyDiv bg-background2">
        <div className="container w-full mx-auto">
              <div className="flex flex-col gap-8">
                <FeatureBoxes icon={features[0].icon} title={features[0].title} description={features[0].description} image={features[0].image} size={features[0].size} index={0}/>
                <div className="flex flex-col justify-between gap-8 lg:flex-row">
                  <FeatureBoxes icon={features[1].icon} title={features[1].title} description={features[1].description} image={features[1].image} size={features[1].size} index={1}/>
                  <FeatureBoxes icon={features[2].icon} title={features[2].title} description={features[2].description} image={features[2].image} size={features[2].size} index={2}/>
                </div>
                <FeatureBoxes icon={features[3].icon} title={features[3].title} description={features[3].description} image={features[3].image} size={features[3].size} index={3}/>
              </div>
            </div>
      </section>
