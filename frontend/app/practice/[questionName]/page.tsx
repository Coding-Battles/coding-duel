...
export default function PracticePage() {
  ...
  useEffect(() => {
    ...
    const fetchQuestion = async () => {
      try {
        console.log("🚀 [PRACTICE DEBUG] Starting to fetch question:", questionName);
        setLoading(true);
        if (!questionName)
          throw new Error(
        ...
        console.log("🚀 [PRACTICE DEBUG] Question data loaded successfully:", !!data);
  ...
  useEffect(() => {
    console.log("🚀 [PRACTICE DEBUG] useEffect triggered - questionData:", !!questionData, "selectedLanguage:", selectedLanguage);
    if (questionData && questionData.starter_code) {
      const starterCode = questionData.starter_code[selectedLanguage];
      console.log("🚀 [PRACTICE DEBUG] Found starter code for", selectedLanguage, ":", !!starterCode, "length:", starterCode?.length);
      if (starterCode) {
        setUserCode(starterCode);
        console.log("🚀 [PRACTICE DEBUG] Set userCode to starter code");
      }
    } else {
      console.warn("🚀 [PRACTICE DEBUG] Missing questionData or starter_code:", {
      ...
      setAlerts((prev) => [
        ...prev,
        {
          ...
          message: result.success 
            ? `✅ Sample tests passed! ${result.total_passed}/${result.total_passed + result.total_failed} tests passed`
            : `❌ Sample tests failed: ${result.total_passed}/${result.total_passed + result.total_failed} tests passed`,
    ...
    try {
      ...
      setAlerts((prev) => [
        ...prev,
        {
          ...
          message: result.success 
            ? `🎉 All tests passed! ${result.total_passed}/${result.total_passed + result.total_failed} tests passed`
            : `📝 Tests completed: ${result.total_passed}/${result.total_passed + result.total_failed} tests passed`,
          variant: result.success ? "default" : "destructive",
        },
      ]);
          ...
          <div className="p-4">
            <div className="space-y-4">
              ...
              <div className="p-4 border rounded-lg bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800">
                <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">How to Practice:</h4>
              ...
              {testResults && (
                <div className="p-4 border rounded-lg">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    <div>Tests Passed: {testResults.total_passed}/{testResults.total_passed + testResults.total_failed}</div>
                    {testResults.error && (
