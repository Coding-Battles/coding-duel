...
export function transformLeetCodeHtml(html: string): string {
  return (
    html
      ...
      .replace(
        /class="bg-blue-50 p-4 rounded-lg"/g,
        'class="leetcode-constraints"'
      )

      // Transform inline code elements
      .replace(
        /class="bg-gray-100 px-1 py-0\.5 rounded text-sm"/g,
        'class="leetcode-code"'
      )
      .replace(
        /class="bg-white px-1 py-0\.5 rounded"/g,
        'class="leetcode-code"'
      )
      ...
      .replace(
        /class="font-semibold mb-2 text-blue-800"/g,
        'class="leetcode-heading"'
      )
      ...
      .replace(
        /<div><strong>Explanation:<\/strong>/g,
        '<div class="leetcode-explanation"><strong>Explanation:</strong>'
      )
  );
}
