...
def test_failing_problems():
    """Test some of the failing problems to understand the issues"""
    ...
    for problem in problems:
        ...
        try:
            # Test with Python first since it's usually most reliable
            file_path = f"/Users/andriysapeha/Documents/coding_duel/coding-duel/backend/test-solutions/{problem}.py"
            ...
            if response.status_code == 200:
                ...
                if result.get("test_results"):
                    ...
                    if failed:
                        ...
                        print(f"  Expected: {failed[0].get('expected_output', 'N/A')}")
